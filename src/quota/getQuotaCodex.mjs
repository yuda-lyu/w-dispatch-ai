...
//   認證、權杖刷新、CODEX_HOME與多帳號皆由codex自理, 本路徑不讀auth.json、不碰任何token;
...
//   或RPC失敗時退回直打(實測200), 憑證取自<CODEX_HOME|~/.codex>/auth.json; 該回應本身即帶
 ...
 * @param {String} [opt.codexHome] 輸入codex設定目錄字串(備援用)，預設取環境變數CODEX_HOME，未設則<homeDir>/.codex
